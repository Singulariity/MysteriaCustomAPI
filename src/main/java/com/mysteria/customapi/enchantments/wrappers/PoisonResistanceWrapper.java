...
public class PoisonResistanceWrapper extends CustomEnchantmentWrapper {

	public PoisonResistanceWrapper() {
		super("poison_resistance");
	}
	...
	public @NotNull String getName() {
		return "Resistance against Poisoning";
	}
	...
	Component displayName(int level) {
		return Component.translatable("enchantment.minecraft.poison_resistance");
	}
}
