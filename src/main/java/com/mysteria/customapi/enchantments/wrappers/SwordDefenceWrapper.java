...
public class SwordDefenceWrapper extends CustomEnchantmentWrapper {
	public SwordDefenceWrapper() {
		super("sword_defence");
	}
	...
	public @NotNull Component displayName(int level) {
		return Component.translatable("enchantment.minecraft.sword_defence");
	}
}
