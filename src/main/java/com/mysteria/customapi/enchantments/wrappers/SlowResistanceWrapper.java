...
public class SlowResistanceWrapper extends CustomEnchantmentWrapper {

	public SlowResistanceWrapper() {
		super("slow_resistance");
	}
	...
	public @NotNull String getName() {
		return "Resistance against Slowing";
	}
	...
	public @NotNull Component displayName(int level) {
		return Component.translatable("enchantment.minecraft.slow_resistance");
	}
}
