...
public class LevitationResistanceWrapper extends CustomEnchantmentWrapper {

	public LevitationResistanceWrapper() {
		super("levitation_resistance");
	}
	...
	public @NotNull String getName() {
		return "Resistance against Levitation";
	}
	...
	public boolean conflictsWith(@NotNull Enchantment other) {
		return other == CustomEnchantment.FROSTBURN_RESISTANCE ||
				other == CustomEnchantment.SLOW_RESISTANCE ||
	...
	Component displayName(int level) {
		return Component.translatable("enchantment.minecraft.levitation_resistance");
	}
}
