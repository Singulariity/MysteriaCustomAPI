...
public class ArrowDefenceWrapper extends CustomEnchantmentWrapper {
	public ArrowDefenceWrapper() {
		super("arrow_defence");
	}
	...
	public @NotNull Component displayName(int level) {
		return Component.translatable("enchantment.minecraft.arrow_defence");
	}
}
