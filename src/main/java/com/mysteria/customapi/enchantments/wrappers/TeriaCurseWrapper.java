...
public class TeriaCurseWrapper extends CustomEnchantmentWrapper {

	public TeriaCurseWrapper() {
		super("teria_curse");
	}
	...
	public @NotNull Component displayName(int level) {
		return Component.translatable("enchantment.minecraft.teria_curse");
	}
}
