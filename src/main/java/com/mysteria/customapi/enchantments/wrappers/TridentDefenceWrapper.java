...
public class TridentDefenceWrapper extends CustomEnchantmentWrapper {

	public TridentDefenceWrapper() {
		super("trident_defence");
	}
	...
	public @NotNull Component displayName(int level) {
		return Component.translatable("enchantment.minecraft.trident_defence");
	}
}
