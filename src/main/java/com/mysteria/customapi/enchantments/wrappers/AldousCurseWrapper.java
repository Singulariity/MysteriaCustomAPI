...
public class AldousCurseWrapper extends CustomEnchantmentWrapper {

	public AldousCurseWrapper() {
		super("aldous_curse");
	}
	...
	public @NotNull Component displayName(int level) {
		return Component.translatable("enchantment.minecraft.aldous_curse");
	}
}
