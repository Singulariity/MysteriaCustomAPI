...
public class BleedResistanceWrapper extends CustomEnchantmentWrapper {

	public BleedResistanceWrapper() {
		super("bleed_resistance");
	}
	...
	public @NotNull String getName() {
		return "Resistance against Bleeding";
	}
	...
	Component displayName(int level) {
		return Component.translatable("enchantment.minecraft.bleed_resistance");
	}
}
