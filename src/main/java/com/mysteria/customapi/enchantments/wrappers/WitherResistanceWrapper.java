...
public class WitherResistanceWrapper extends CustomEnchantmentWrapper {

	public WitherResistanceWrapper() {
		super("wither_resistance");
	}
	...
	public @NotNull String getName() {
		return "Resistance against Wither";
	}
	...
	Component displayName(int level) {
		return Component.translatable("enchantment.minecraft.wither_resistance");
	}
}
